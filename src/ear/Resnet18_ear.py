...
<<<<<<< HEAD:src/throat/Mobilenet_throat.py
import os
import sys

import yaml
=======
>>>>>>> origin/dev:src/ear/Resnet18_ear.py
...
=======
from utils.trainers.models import resnet_18
from utils.trainers import train_one_epoch
from utils.evaluation import save_metrics_plots, validate_one_epoch
...
# Initialize the model and set up configurations
model = resnet_18(len(train_dataset_classes))
# model.config.id2label = id2label
# model.config.label2id = label2id
model.to(device)
