...
model = CustomConvNextV2Model.from_pretrained("facebook/convnextv2-nano-22k-224", num_channels=3, ignore_mismatched_sizes=True,num_class=len(train_dataset_classes))
...
optimizer = optim.AdamW(model.parameters(), lr=config['training']['lr'],betas =(0.9, 0.999),eps =1e-8,weight_decay=0.01)
