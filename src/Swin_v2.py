...
from utils.trainers.models import swin_v2
...
model = swin_v2(len(train_dataset_classes))
# model.config.id2label = id2label
# model.config.label2id = label2id
model.to(device)

# Initialize optimizer and loss criterion
optimizer = optim.AdamW(model.parameters(), lr=config['training']['lr'],weight_decay=0.1,betas=(0.9, 0.999), eps=1e-08)
